...
while(cap.isOpened()):
    ...
    if count_defects == 1:
        cv2.putText(
            img, "I am Mehul", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
    elif count_defects == 2:
        str = "This is a basic hand gesture recognizer"
        cv2.putText(img, str, (5, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, 2)
    elif count_defects == 3:
#subprocess.Popen(["open", '/Users/mehul/Library/Caches/Metadata/Safari/Bookmarks/xvid.webbookmark'])
        cv2.putText(
            img, "This is 3 :P", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 2, 2)
